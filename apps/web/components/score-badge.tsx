...
export function ScoreBadge({
  ...
  return (
    <div className={cn('flex flex-col items-center gap-2', className)}>
      <div
        className={cn(
          'rounded-full flex items-center justify-center border-2 border-current/20',
          config.circle,
          colorClass
        )}
        role="img"
...
// ---- Score Ring (SVG circle for large display) ----
...
export function ScoreRing({
  ...
  const strokeColor = colorMap[label]
